...
describe("solana-twitter", () => {
  ...
  it("can send a new tweet", async () => {
    ...
    console.log("Hehe wallet : " + tweet.publicKey);
    ...
    console.log("Hehe : " + tweetAccount.author.toBase58());
    console.log("meme : " + program.provider.wallet.publicKey.toBase58());
    ...
    //   program.provider.wallet.publicKey.toBase58()
    // );
    const buffer = await anchor
      .getProvider()
      .connection.getAccountInfo(tweet.publicKey);

    console.log("Buffer data is  : " + buffer.data.readBigUInt64LE(8));
